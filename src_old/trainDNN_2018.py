...
def trainKeras(dataPath,inputVars,name,treeName,target="genMET/PuppiMET",patchedTrain=True,genMETweighted=False,updateInput=False,permuationImportance=False,normalize=False,standardize=False):
        ...
        if target!="genMET/PuppiMET":
            modelName=name+"_"+"_"+target+"_2018_"+stringStart
        else:
            modelName=name+"_2018_"+stringStart
        ...
        #save Model
        my_model.model.save('trainedModel_Keras/2018/'+modelName)
        my_model.model.save('trainedModel_Keras/2018/'+modelName+".h5")
...
if __name__ == "__main__":
    ...
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo","TTbar_amcatnlo",updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo","TTbar_amcatnlo",updateInput=False)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo","TTbar_amcatnlo","PuppiMET-genMET",updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=False)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo","TTbar_amcatnlo","genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo","TTbar_amcatnlo","PtNuNu",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_MSE","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_MAPE","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=False)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_EP100","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_emu","TTbar_amcatnlo_emu","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_FristBatchNorm_emu","TTbar_amcatnlo_emu","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_FristBatchNorm_removeNonNeg_emu","TTbar_amcatnlo_emu","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_FristBatchNorm_removeNonNeg_30EP_emu","TTbar_amcatnlo_emu","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_FristBatchNorm_removeNonNeg_200Shift_emu","TTbar_amcatnlo_emu","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_MinMaxScaled","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=False,normalize=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_StandardScaled","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=False,standardize=True)
    #  ~trainKeras(dataPath,inputVars,"Inlusive_amcatnlo_MAPE_removeNonNeg","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo_30EP","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,genMETweighted=True,updateInput=False)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo_30EP_sqrt","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,genMETweighted=True,updateInput=False)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo_30EP_sqrt_305Bins","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,genMETweighted=True,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo_30EP_sqrt_20Bins","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,genMETweighted=True,updateInput=True)
    #  ~trainKeras(dataPath,inputVars,"InlusivePatched_amcatnlo_30EP","TTbar_amcatnlo","PuppiMET-genMET",patchedTrain=False,updateInput=True)
